...
const SimpleStatusUpdateModal = ({ bed, isOpen, onClose, onUpdate, isOffline = false }) => {
  ...
  return (
    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-3 sm:p-4">
      <div 
        className="bg-slate-800 rounded-lg p-4 sm:p-6 max-w-md w-full border border-slate-700 max-h-[90vh] overflow-y-auto"
      ...
      >
        ...
        <button
          onClick={onClose}
          className="w-full bg-slate-700 hover:bg-slate-600 active:bg-slate-500 text-white py-3 rounded-lg transition-all min-h-[48px] touch-manipulation text-sm sm:text-base"
